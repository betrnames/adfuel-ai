...
async function createPgliteSql(): Promise<Sql> {
  ...
  // — so an HMR reload after adding a migration file (0005_connections) applies it live — with
 ...
 * New migration files apply on the next getSql pass after this module reloads.
 */
